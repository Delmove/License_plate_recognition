                ...
                for de, lic_plat in zip(det, plat_num):
                    ...
                    *xyxy, conf, cls = de
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        sql = 'update hdcar.car_car set out_date=%s where plate_number=%s'
                        cur.execute(sql, (out_time, lb))
                        conn.commit()
                        cur.close()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='http://admin:admin@10.37.29.42:8081',
